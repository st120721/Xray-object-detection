...
def decimate(tensor, m):
    # downsample tensor to a desired size
...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self,path_pretrained_state_dict=False):
        ...
        # Pretrained VGG base
        #pretrained_state_dict = torchvision.models.vgg16(pretrained=True).state_dict()'./best_vgg_state_dict.pth'
...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(self, priors_cxcy, threshold=0.5, neg_pos_ratio=3, alpha=1.):
        ...
        self.priors_cxcy = priors_cxcy  # (c_x, c_y, w, h)
        self.priors_xy = cxcy_to_xy(priors_cxcy)  # (x_min, y_min, x_max, y_max)
